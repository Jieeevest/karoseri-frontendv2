...
export default function EditInventory() {
  ...
  const { data: inventoryData } = useGetInventoryByIdQuery(Number(id));
  ...
  useEffect(() => {
    if (inventoryData?.data) {
      ...
      setPayload({
        ...
        amount: currentData?.amount?.toString() ?? "0",
      ...
      <div className="pb-10 -mt-5">
        ...
        {openModal && (
          <ConfirmationModal
            showModal={openModal}
            title="Konfirmasi"
            message="Apakah anda ingin melakukan perubahan data barang ini?"
            buttonText="Ya, Ubah"
